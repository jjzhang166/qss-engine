...
MOD_definition(int i, double *x, double *d, double *alg, double t, double *dx)
{
	...
	{
		case 0:
			dx[1] = (-x[0]*__PAR_ax/__PAR_dx)+(-x[0]*__PAR_ay/__PAR_dy)+__PAR_r*(pow(x[0],2.0))*(1.0-x[0]);
			return;
		case 1000:
			dx[1] = (-x[3000]*__PAR_ax/__PAR_dx)+(-x[3000]+x[0])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[3000],2.0))*(2.0-x[3000]);
			return;
		case 2000:
			dx[1] = (-x[6000]*__PAR_ax/__PAR_dx)+(-x[6000]+x[3000])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[6000],2.0))*(2.0-x[6000]);
			return;
		case 3000:
			dx[1] = (-x[9000]*__PAR_ax/__PAR_dx)+(-x[9000]+x[6000])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[9000],2.0))*(2.0-x[9000]);
			return;
		case 4000:
			dx[1] = (-x[12000]*__PAR_ax/__PAR_dx)+(-x[12000]+x[9000])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[12000],2.0))*(2.0-x[12000]);
			return;
		case 5000:
			dx[1] = (-x[15000]*__PAR_ax/__PAR_dx)+(-x[15000]+x[12000])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[15000],2.0))*(2.0-x[15000]);
			return;
		case 6000:
			dx[1] = (-x[18000]*__PAR_ax/__PAR_dx)+(-x[18000]+x[15000])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[18000],2.0))*(2.0-x[18000]);
			return;
		case 7000:
			dx[1] = (-x[21000]*__PAR_ax/__PAR_dx)+(-x[21000]+x[18000])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[21000],2.0))*(2.0-x[21000]);
			return;
		case 8000:
			dx[1] = (-x[24000]*__PAR_ax/__PAR_dx)+(-x[24000]+x[21000])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[24000],2.0))*(2.0-x[24000]);
			return;
		case 9000:
			dx[1] = (-x[27000]*__PAR_ax/__PAR_dx)+(-x[27000]+x[24000])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[27000],2.0))*(2.0-x[27000]);
			return;
		default:
			j = i;
			if(j >=1 && j <= 999)
			{
				dx[1] = (-x[(j) * 3]+x[(j-1) * 3])*__PAR_ax/__PAR_dx+(-x[(j) * 3]*__PAR_ay/__PAR_dy)+__PAR_r*(pow(x[(j) * 3],2.0))*(1.0-x[(j) * 3]);
			}
			j = i-1000;
			if(j >=1 && j <= 999)
			{
				dx[1] = (-x[(j+1000) * 3]+x[(j+999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+1000) * 3]+x[(j) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+1000) * 3],2.0))*(1.0-x[(j+1000) * 3]);
			}
			j = i-2000;
			if(j >=1 && j <= 999)
			{
				dx[1] = (-x[(j+2000) * 3]+x[(j+1999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+2000) * 3]+x[(j+1000) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+2000) * 3],2.0))*(1.0-x[(j+2000) * 3]);
			}
			j = i-3000;
			if(j >=1 && j <= 999)
			{
				dx[1] = (-x[(j+3000) * 3]+x[(j+2999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+3000) * 3]+x[(j+2000) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+3000) * 3],2.0))*(1.0-x[(j+3000) * 3]);
			}
			j = i-4000;
			if(j >=1 && j <= 999)
			{
				dx[1] = (-x[(j+4000) * 3]+x[(j+3999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+4000) * 3]+x[(j+3000) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+4000) * 3],2.0))*(1.0-x[(j+4000) * 3]);
			}
			j = i-5000;
			if(j >=1 && j <= 999)
			{
				dx[1] = (-x[(j+5000) * 3]+x[(j+4999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+5000) * 3]+x[(j+4000) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+5000) * 3],2.0))*(1.0-x[(j+5000) * 3]);
			}
			j = i-6000;
			if(j >=1 && j <= 999)
			{
				dx[1] = (-x[(j+6000) * 3]+x[(j+5999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+6000) * 3]+x[(j+5000) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+6000) * 3],2.0))*(1.0-x[(j+6000) * 3]);
			}
			j = i-7000;
			if(j >=1 && j <= 999)
			{
				dx[1] = (-x[(j+7000) * 3]+x[(j+6999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+7000) * 3]+x[(j+6000) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+7000) * 3],2.0))*(1.0-x[(j+7000) * 3]);
			}
			j = i-8000;
			if(j >=1 && j <= 999)
			{
				dx[1] = (-x[(j+8000) * 3]+x[(j+7999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+8000) * 3]+x[(j+7000) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+8000) * 3],2.0))*(1.0-x[(j+8000) * 3]);
			}
			j = i-9000;
			if(j >=1 && j <= 999)
			{
				dx[1] = (-x[(j+9000) * 3]+x[(j+8999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+9000) * 3]+x[(j+8000) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+9000) * 3],2.0))*(1.0-x[(j+9000) * 3]);
			}
	}
}
...
MOD_dependencies(int i, double *x, double *d, double *alg, double t, double *der, int *map)
{
	...
	{
		case 0:
			der[0 + 1] = (-x[0]*__PAR_ax/__PAR_dx)+(-x[0]*__PAR_ay/__PAR_dy)+__PAR_r*(pow(x[0],2.0))*(1.0-x[0]);
			der[3000 + 1] = (-x[3000]*__PAR_ax/__PAR_dx)+(-x[3000]+x[0])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[3000],2.0))*(2.0-x[3000]);
			break;
		case 1000:
			der[3000 + 1] = (-x[3000]*__PAR_ax/__PAR_dx)+(-x[3000]+x[0])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[3000],2.0))*(2.0-x[3000]);
			der[6000 + 1] = (-x[6000]*__PAR_ax/__PAR_dx)+(-x[6000]+x[3000])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[6000],2.0))*(2.0-x[6000]);
			break;
		case 2000:
			der[6000 + 1] = (-x[6000]*__PAR_ax/__PAR_dx)+(-x[6000]+x[3000])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[6000],2.0))*(2.0-x[6000]);
			der[9000 + 1] = (-x[9000]*__PAR_ax/__PAR_dx)+(-x[9000]+x[6000])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[9000],2.0))*(2.0-x[9000]);
			break;
		case 3000:
			der[9000 + 1] = (-x[9000]*__PAR_ax/__PAR_dx)+(-x[9000]+x[6000])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[9000],2.0))*(2.0-x[9000]);
			der[12000 + 1] = (-x[12000]*__PAR_ax/__PAR_dx)+(-x[12000]+x[9000])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[12000],2.0))*(2.0-x[12000]);
			break;
		case 4000:
			der[12000 + 1] = (-x[12000]*__PAR_ax/__PAR_dx)+(-x[12000]+x[9000])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[12000],2.0))*(2.0-x[12000]);
			der[15000 + 1] = (-x[15000]*__PAR_ax/__PAR_dx)+(-x[15000]+x[12000])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[15000],2.0))*(2.0-x[15000]);
			break;
		case 5000:
			der[15000 + 1] = (-x[15000]*__PAR_ax/__PAR_dx)+(-x[15000]+x[12000])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[15000],2.0))*(2.0-x[15000]);
			der[18000 + 1] = (-x[18000]*__PAR_ax/__PAR_dx)+(-x[18000]+x[15000])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[18000],2.0))*(2.0-x[18000]);
			break;
		case 6000:
			der[18000 + 1] = (-x[18000]*__PAR_ax/__PAR_dx)+(-x[18000]+x[15000])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[18000],2.0))*(2.0-x[18000]);
			der[21000 + 1] = (-x[21000]*__PAR_ax/__PAR_dx)+(-x[21000]+x[18000])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[21000],2.0))*(2.0-x[21000]);
			break;
		case 7000:
			der[21000 + 1] = (-x[21000]*__PAR_ax/__PAR_dx)+(-x[21000]+x[18000])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[21000],2.0))*(2.0-x[21000]);
			der[24000 + 1] = (-x[24000]*__PAR_ax/__PAR_dx)+(-x[24000]+x[21000])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[24000],2.0))*(2.0-x[24000]);
			break;
		case 8000:
			der[24000 + 1] = (-x[24000]*__PAR_ax/__PAR_dx)+(-x[24000]+x[21000])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[24000],2.0))*(2.0-x[24000]);
			der[27000 + 1] = (-x[27000]*__PAR_ax/__PAR_dx)+(-x[27000]+x[24000])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[27000],2.0))*(2.0-x[27000]);
			break;
		case 9000:
			der[27000 + 1] = (-x[27000]*__PAR_ax/__PAR_dx)+(-x[27000]+x[24000])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[27000],2.0))*(2.0-x[27000]);
			break;
	...
	if(j >=1 && j <= 999)
	{
		der[(j) * 3 + 1] = (-x[(j) * 3]+x[(j-1) * 3])*__PAR_ax/__PAR_dx+(-x[(j) * 3]*__PAR_ay/__PAR_dy)+__PAR_r*(pow(x[(j) * 3],2.0))*(1.0-x[(j) * 3]);
	}
	j = i;
	if(j >=1 && j <= 999)
	{
		der[(j) * 3 + 1] = (-x[(j) * 3]+x[(j-1) * 3])*__PAR_ax/__PAR_dx+(-x[(j) * 3]*__PAR_ay/__PAR_dy)+__PAR_r*(pow(x[(j) * 3],2.0))*(1.0-x[(j) * 3]);
		der[(j+1000) * 3 + 1] = (-x[(j+1000) * 3]+x[(j+999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+1000) * 3]+x[(j) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+1000) * 3],2.0))*(1.0-x[(j+1000) * 3]);
	}
	j = i-999;
	if(j >=1 && j <= 999)
	{
	...
	{
		der[(j+1000) * 3 + 1] = (-x[(j+1000) * 3]+x[(j+999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+1000) * 3]+x[(j) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+1000) * 3],2.0))*(1.0-x[(j+1000) * 3]);
		der[(j+2000) * 3 + 1] = (-x[(j+2000) * 3]+x[(j+1999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+2000) * 3]+x[(j+1000) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+2000) * 3],2.0))*(1.0-x[(j+2000) * 3]);
	}
	j = i-1999;
	if(j >=1 && j <= 999)
	{
	...
	{
		der[(j+2000) * 3 + 1] = (-x[(j+2000) * 3]+x[(j+1999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+2000) * 3]+x[(j+1000) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+2000) * 3],2.0))*(1.0-x[(j+2000) * 3]);
		der[(j+3000) * 3 + 1] = (-x[(j+3000) * 3]+x[(j+2999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+3000) * 3]+x[(j+2000) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+3000) * 3],2.0))*(1.0-x[(j+3000) * 3]);
	}
	j = i-2999;
	if(j >=1 && j <= 999)
	{
	...
	{
		der[(j+3000) * 3 + 1] = (-x[(j+3000) * 3]+x[(j+2999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+3000) * 3]+x[(j+2000) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+3000) * 3],2.0))*(1.0-x[(j+3000) * 3]);
		der[(j+4000) * 3 + 1] = (-x[(j+4000) * 3]+x[(j+3999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+4000) * 3]+x[(j+3000) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+4000) * 3],2.0))*(1.0-x[(j+4000) * 3]);
	}
	j = i-3999;
	if(j >=1 && j <= 999)
	{
	...
	{
		der[(j+4000) * 3 + 1] = (-x[(j+4000) * 3]+x[(j+3999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+4000) * 3]+x[(j+3000) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+4000) * 3],2.0))*(1.0-x[(j+4000) * 3]);
		der[(j+5000) * 3 + 1] = (-x[(j+5000) * 3]+x[(j+4999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+5000) * 3]+x[(j+4000) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+5000) * 3],2.0))*(1.0-x[(j+5000) * 3]);
	}
	j = i-4999;
	if(j >=1 && j <= 999)
	{
	...
	{
		der[(j+5000) * 3 + 1] = (-x[(j+5000) * 3]+x[(j+4999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+5000) * 3]+x[(j+4000) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+5000) * 3],2.0))*(1.0-x[(j+5000) * 3]);
		der[(j+6000) * 3 + 1] = (-x[(j+6000) * 3]+x[(j+5999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+6000) * 3]+x[(j+5000) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+6000) * 3],2.0))*(1.0-x[(j+6000) * 3]);
	}
	j = i-5999;
	if(j >=1 && j <= 999)
	{
	...
	{
		der[(j+6000) * 3 + 1] = (-x[(j+6000) * 3]+x[(j+5999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+6000) * 3]+x[(j+5000) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+6000) * 3],2.0))*(1.0-x[(j+6000) * 3]);
		der[(j+7000) * 3 + 1] = (-x[(j+7000) * 3]+x[(j+6999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+7000) * 3]+x[(j+6000) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+7000) * 3],2.0))*(1.0-x[(j+7000) * 3]);
	}
	j = i-6999;
	if(j >=1 && j <= 999)
	{
	...
	{
		der[(j+7000) * 3 + 1] = (-x[(j+7000) * 3]+x[(j+6999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+7000) * 3]+x[(j+6000) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+7000) * 3],2.0))*(1.0-x[(j+7000) * 3]);
		der[(j+8000) * 3 + 1] = (-x[(j+8000) * 3]+x[(j+7999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+8000) * 3]+x[(j+7000) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+8000) * 3],2.0))*(1.0-x[(j+8000) * 3]);
	}
	j = i-7999;
	if(j >=1 && j <= 999)
	{
	...
	{
		der[(j+8000) * 3 + 1] = (-x[(j+8000) * 3]+x[(j+7999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+8000) * 3]+x[(j+7000) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+8000) * 3],2.0))*(1.0-x[(j+8000) * 3]);
		der[(j+9000) * 3 + 1] = (-x[(j+9000) * 3]+x[(j+8999) * 3])*__PAR_ax/__PAR_dx+(-x[(j+9000) * 3]+x[(j+8000) * 3])*__PAR_ay/__PAR_dy+__PAR_r*(pow(x[(j+9000) * 3],2.0))*(1.0-x[(j+9000) * 3]);
	}
	j = i-8999;
	if(j >=1 && j <= 999)
	{
...
QSS_data modelData = simulator->data;
	...
	__PAR_dT = 1.000000000000000020816682e-03;
	__PAR_ax = 1.0;
	__PAR_ay = 1.0;
	__PAR_r = 1000.0;
	__PAR_dx = 10.0/1000;
