...
double __k15 = 0;
double __k_plus16 = 0;
double __k_minus16 = 0;
double __k_plus17 = 0;
double __k_minus17 = 0;
double __Vmax1 = 0;
double __Km1 = 0;
double __Ki = 0;
double __Vmax2 = 0;
...
double __Vmax7 = 0;
double __Km14 = 0;
double __normal_bCatenin_TCF = 0;
double __n = 0;
double __ap = 0;
double __bp = 0;
double __mp = 0;
...
MOD_definition(int i, double *x, double *d, double *alg, double t, double *dx)
{
	...
	{
		case 0:
			alg[21] = __cytoplasm*__k1*x[0]*d[(3)];
			alg[27] = __cytoplasm*__k2*x[3];
			dx[1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[21])+(1.000000000000000000000000e+00*alg[27]));
			return;
		case 1:
			alg[21] = __cytoplasm*__k1*x[0]*d[(3)];
			alg[27] = __cytoplasm*__k2*x[3];
			...
			return;
		case 2:
			alg[33] = __cytoplasm*__k5*x[6];
			alg[36] = __cytoplasm*(__k_plus8*x[6]*x[30]-__k_minus8*x[21]);
			alg[39] = __cytoplasm*__k4*x[9];
			alg[57] = __cytoplasm*__k10*x[24];
			dx[1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[39])+(-1.000000000000000000000000e+00*alg[33])+(-1.000000000000000000000000e+00*alg[36])+(1.000000000000000000000000e+00*alg[57]));
			return;
		case 3:
			alg[30] = __cytoplasm*__k3*x[3]*x[9];
			alg[33] = __cytoplasm*__k5*x[6];
			alg[39] = __cytoplasm*__k4*x[9];
			alg[42] = __cytoplasm*(__k_plus6*x[12]*x[15]-__k_minus6*x[9]);
			dx[1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[30])+(-1.000000000000000000000000e+00*alg[39])+(1.000000000000000000000000e+00*alg[33])+(1.000000000000000000000000e+00*alg[42]));
			return;
		case 4:
			alg[30] = __cytoplasm*__k3*x[3]*x[9];
			alg[42] = __cytoplasm*(__k_plus6*x[12]*x[15]-__k_minus6*x[9]);
			alg[45] = __cytoplasm*__kcat7*x[66]*x[12]*1.000000000000000000000000e+00/(__Km13+x[12]);
			alg[114] = __cytoplasm*__Vmax7*x[81]*1.000000000000000000000000e+00/(__Km14+x[81]);
			dx[1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[30])+(-1.000000000000000000000000e+00*alg[42])+(-1.000000000000000000000000e+00*alg[45])+(1.000000000000000000000000e+00*alg[114]));
			return;
		case 5:
			alg[30] = __cytoplasm*__k3*x[3]*x[9];
			alg[42] = __cytoplasm*(__k_plus6*x[12]*x[15]-__k_minus6*x[9]);
			alg[48] = __cytoplasm*(__k_plus7*x[18]*x[33]-__k_minus7*x[15]);
			dx[1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[30])+(-1.000000000000000000000000e+00*alg[42])+(1.000000000000000000000000e+00*alg[48]));
			return;
		case 6:
			alg[48] = __cytoplasm*(__k_plus7*x[18]*x[33]-__k_minus7*x[15]);
			alg[51] = __cytoplasm*(__k_plus17*x[18]*x[30]-__k_minus17*x[42]);
			dx[1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[48])+(-1.000000000000000000000000e+00*alg[51]));
			return;
		case 7:
			alg[36] = __cytoplasm*(__k_plus8*x[6]*x[30]-__k_minus8*x[21]);
			alg[54] = __cytoplasm*__k9*x[21];
			dx[1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[36])+(-1.000000000000000000000000e+00*alg[54]));
			return;
		case 8:
			alg[54] = __cytoplasm*__k9*x[21];
			alg[57] = __cytoplasm*__k10*x[24];
			dx[1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[54])+(-1.000000000000000000000000e+00*alg[57]));
			return;
		case 9:
			alg[57] = __cytoplasm*__k10*x[24];
			alg[60] = __cytoplasm*__k11*x[27];
			dx[1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[57])+(-1.000000000000000000000000e+00*alg[60]));
			return;
		case 10:
			alg[36] = __cytoplasm*(__k_plus8*x[6]*x[30]-__k_minus8*x[21]);
			alg[51] = __cytoplasm*(__k_plus17*x[18]*x[30]-__k_minus17*x[42]);
			alg[63] = __nucleus*__k13*x[30];
			alg[69] = __nucleus*(__k_plus16*x[30]*x[36]-__k_minus16*x[39]);
			alg[120] = __cytoplasm*__V12;
			dx[1] = (1.000000000000000000000000e+00/(__nucleus))*((-1.000000000000000000000000e+00*alg[36])+(1.000000000000000000000000e+00*alg[120])+(-1.000000000000000000000000e+00*alg[63])+(-1.000000000000000000000000e+00*alg[69])+(-1.000000000000000000000000e+00*alg[51]));
			return;
		case 11:
			alg[48] = __cytoplasm*(__k_plus7*x[18]*x[33]-__k_minus7*x[15]);
			alg[66] = __nucleus*(__k14+__k21*(x[30]+x[39]));
			alg[72] = __cytoplasm*__k15*x[33];
			dx[1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[48])+(1.000000000000000000000000e+00*alg[66])+(-1.000000000000000000000000e+00*alg[72]));
			return;
		case 12:
			alg[69] = __nucleus*(__k_plus16*x[30]*x[36]-__k_minus16*x[39]);
			dx[1] = (1.000000000000000000000000e+00/(__nucleus))*((-1.000000000000000000000000e+00*alg[69]));
			return;
		case 13:
			alg[69] = __nucleus*(__k_plus16*x[30]*x[36]-__k_minus16*x[39]);
			dx[1] = (1.000000000000000000000000e+00/(__nucleus))*((1.000000000000000000000000e+00*alg[69]));
		...
		case 14:
			alg[51] = __cytoplasm*(__k_plus17*x[18]*x[30]-__k_minus17*x[42]);
			dx[1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[51]));
			return;
		case 15:
			alg[24] = __cytoplasm*__Vmax1*x[45]*d[(3)]*1.000000000000000000000000e+00/(__Km1+x[45])*__Ki*1.000000000000000000000000e+00/(__Ki+x[66]);
			alg[78] = __cytoplasm*__Vmax2*x[48]*1.000000000000000000000000e+00/(__Km2+x[48]);
			dx[1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[24])+(1.000000000000000000000000e+00*alg[78]));
			return;
		case 16:
			alg[24] = __cytoplasm*__Vmax1*x[45]*d[(3)]*1.000000000000000000000000e+00/(__Km1+x[45])*__Ki*1.000000000000000000000000e+00/(__Ki+x[66]);
			alg[78] = __cytoplasm*__Vmax2*x[48]*1.000000000000000000000000e+00/(__Km2+x[48]);
			...
			return;
		case 17:
			alg[81] = __cytoplasm*__kcat1*x[48]*x[51]*1.000000000000000000000000e+00/(__Km3+x[51]);
			alg[84] = __cytoplasm*(__k18*x[51]*x[72]-__k19*x[69]);
			alg[87] = __cytoplasm*__kcat6*x[78]*x[51]*1.000000000000000000000000e+00/(__Km12+x[51]);
			alg[90] = __cytoplasm*__Vmax3*x[54]*1.000000000000000000000000e+00/(__Km4+x[54]);
			alg[105] = __cytoplasm*__kcat4*x[66]*x[69]*1.000000000000000000000000e+00/(__Km9+x[69]);
			dx[1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[81])+(1.000000000000000000000000e+00*alg[90])+(1.000000000000000000000000e+00*alg[105])+(-1.000000000000000000000000e+00*alg[84])+(-1.000000000000000000000000e+00*alg[87]));
			return;
		case 18:
			alg[81] = __cytoplasm*__kcat1*x[48]*x[51]*1.000000000000000000000000e+00/(__Km3+x[51]);
			alg[87] = __cytoplasm*__kcat6*x[78]*x[51]*1.000000000000000000000000e+00/(__Km12+x[51]);
			alg[90] = __cytoplasm*__Vmax3*x[54]*1.000000000000000000000000e+00/(__Km4+x[54]);
			dx[1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[81])+(-1.000000000000000000000000e+00*alg[90])+(1.000000000000000000000000e+00*alg[87]));
			return;
		case 19:
			alg[93] = __cytoplasm*__kcat2*x[54]*x[57]*1.000000000000000000000000e+00/(__Km5+x[57]);
			alg[96] = __cytoplasm*__Vmax4*x[60]*1.000000000000000000000000e+00/(__Km6+x[60]);
			dx[1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[93])+(1.000000000000000000000000e+00*alg[96]));
			return;
		case 20:
			alg[93] = __cytoplasm*__kcat2*x[54]*x[57]*1.000000000000000000000000e+00/(__Km5+x[57]);
			alg[96] = __cytoplasm*__Vmax4*x[60]*1.000000000000000000000000e+00/(__Km6+x[60]);
			...
			return;
		case 21:
			alg[99] = __cytoplasm*__kcat3*x[60]*x[63]*1.000000000000000000000000e+00/(__Km7+x[63]);
			alg[102] = __cytoplasm*__Vmax5*x[66]*1.000000000000000000000000e+00/(__Km8+x[66]);
			dx[1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[99])+(1.000000000000000000000000e+00*alg[102]));
			return;
		case 22:
			alg[99] = __cytoplasm*__kcat3*x[60]*x[63]*1.000000000000000000000000e+00/(__Km7+x[63]);
			alg[102] = __cytoplasm*__Vmax5*x[66]*1.000000000000000000000000e+00/(__Km8+x[66]);
		...
		case 23:
			alg[84] = __cytoplasm*(__k18*x[51]*x[72]-__k19*x[69]);
			alg[105] = __cytoplasm*__kcat4*x[66]*x[69]*1.000000000000000000000000e+00/(__Km9+x[69]);
			dx[1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[105])+(1.000000000000000000000000e+00*alg[84]));
			return;
		case 24:
			alg[84] = __cytoplasm*(__k18*x[51]*x[72]-__k19*x[69]);
			alg[108] = __cytoplasm*__Vmax6*x[75]*1.000000000000000000000000e+00/(__Km10+x[75]);
			dx[1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[84])+(1.000000000000000000000000e+00*alg[108]));
			return;
		case 25:
			alg[105] = __cytoplasm*__kcat4*x[66]*x[69]*1.000000000000000000000000e+00/(__Km9+x[69]);
			alg[108] = __cytoplasm*__Vmax6*x[75]*1.000000000000000000000000e+00/(__Km10+x[75]);
			dx[1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[105])+(-1.000000000000000000000000e+00*alg[108]));
			return;
		case 26:
			alg[75] = __cytoplasm*__kcat5*__math__pow(x[39],(__n1))*1.000000000000000000000000e+00/(__math__pow(__Km11,(__n1))+__math__pow(x[39],(__n1)));
			alg[111] = __cytoplasm*__k20*x[78];
			dx[1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[75])+(-1.000000000000000000000000e+00*alg[111]));
			return;
		case 27:
			alg[45] = __cytoplasm*__kcat7*x[66]*x[12]*1.000000000000000000000000e+00/(__Km13+x[12]);
			alg[114] = __cytoplasm*__Vmax7*x[81]*1.000000000000000000000000e+00/(__Km14+x[81]);
			dx[1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[45])+(-1.000000000000000000000000e+00*alg[114]));
			return;
		case 28:
			alg[0] = d[(2)];
			alg[3] = alg[0];
			dx[1] = (__ap*__math__pow(x[84],__n)+__bp)*1.000000000000000000000000e+00/(__mp+alg[3]+__cpp*__math__pow(x[84],__n))-__kp*x[84];
			return;
		case 29:
			alg[6] = d[(0)];
			alg[9] = alg[6];
			alg[12] = alg[9];
			dx[1] = (__ao*__math__pow(x[87],__n)+__bo+alg[12])*1.000000000000000000000000e+00/(__mo+__coo*__math__pow(x[87],__n)+__coa*__math__pow(x[90],__n)+__cop*__math__pow(x[84],__n))-__ko*x[87];
			return;
		case 30:
			alg[15] = d[(6)];
			alg[18] = alg[15];
			dx[1] = (__aa*__math__pow(x[90],__n)+__ba+alg[18])*1.000000000000000000000000e+00/(__ma+__caa*__math__pow(x[90],__n)+__cao*__math__pow(x[87],__n)+__cap*__math__pow(x[84],__n))-__ka*x[90];
			return;
	}
}
...
MOD_dependencies(int i, double *x, double *d, double *alg, double t, double *der, int *map)
{
	switch(i)
	{
		case 0:
			alg[21] = __cytoplasm*__k1*x[0]*d[(3)];
			alg[27] = __cytoplasm*__k2*x[3];
			der[0 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[21])+(1.000000000000000000000000e+00*alg[27]));
			der[3 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[21])+(-1.000000000000000000000000e+00*alg[27]));
			return;
		case 1:
			alg[21] = __cytoplasm*__k1*x[0]*d[(3)];
			alg[27] = __cytoplasm*__k2*x[3];
			...
			der[0 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[21])+(1.000000000000000000000000e+00*alg[27]));
			der[3 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[21])+(-1.000000000000000000000000e+00*alg[27]));
			der[9 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[30])+(-1.000000000000000000000000e+00*alg[39])+(1.000000000000000000000000e+00*alg[33])+(1.000000000000000000000000e+00*alg[42]));
			der[12 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[30])+(-1.000000000000000000000000e+00*alg[42])+(-1.000000000000000000000000e+00*alg[45])+(1.000000000000000000000000e+00*alg[114]));
			der[15 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[30])+(-1.000000000000000000000000e+00*alg[42])+(1.000000000000000000000000e+00*alg[48]));
			return;
		case 2:
			alg[30] = __cytoplasm*__k3*x[3]*x[9];
			alg[33] = __cytoplasm*__k5*x[6];
			...
			alg[69] = __nucleus*(__k_plus16*x[30]*x[36]-__k_minus16*x[39]);
			alg[120] = __cytoplasm*__V12;
			der[6 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[39])+(-1.000000000000000000000000e+00*alg[33])+(-1.000000000000000000000000e+00*alg[36])+(1.000000000000000000000000e+00*alg[57]));
			der[9 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[30])+(-1.000000000000000000000000e+00*alg[39])+(1.000000000000000000000000e+00*alg[33])+(1.000000000000000000000000e+00*alg[42]));
			der[21 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[36])+(-1.000000000000000000000000e+00*alg[54]));
			der[30 + 1] = (1.000000000000000000000000e+00/(__nucleus))*((-1.000000000000000000000000e+00*alg[36])+(1.000000000000000000000000e+00*alg[120])+(-1.000000000000000000000000e+00*alg[63])+(-1.000000000000000000000000e+00*alg[69])+(-1.000000000000000000000000e+00*alg[51]));
			return;
		case 3:
			alg[30] = __cytoplasm*__k3*x[3]*x[9];
			alg[33] = __cytoplasm*__k5*x[6];
		...
		case 4:
			...
			der[12 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[30])+(-1.000000000000000000000000e+00*alg[42])+(-1.000000000000000000000000e+00*alg[45])+(1.000000000000000000000000e+00*alg[114]));
			der[15 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[30])+(-1.000000000000000000000000e+00*alg[42])+(1.000000000000000000000000e+00*alg[48]));
			der[81 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[45])+(-1.000000000000000000000000e+00*alg[114]));
			return;
		case 5:
			alg[30] = __cytoplasm*__k3*x[3]*x[9];
			alg[33] = __cytoplasm*__k5*x[6];
			...
			der[12 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[30])+(-1.000000000000000000000000e+00*alg[42])+(-1.000000000000000000000000e+00*alg[45])+(1.000000000000000000000000e+00*alg[114]));
			der[15 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[30])+(-1.000000000000000000000000e+00*alg[42])+(1.000000000000000000000000e+00*alg[48]));
			der[18 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[48])+(-1.000000000000000000000000e+00*alg[51]));
			der[33 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[48])+(1.000000000000000000000000e+00*alg[66])+(-1.000000000000000000000000e+00*alg[72]));
			return;
		case 6:
			alg[30] = __cytoplasm*__k3*x[3]*x[9];
			alg[36] = __cytoplasm*(__k_plus8*x[6]*x[30]-__k_minus8*x[21]);
			...
			der[30 + 1] = (1.000000000000000000000000e+00/(__nucleus))*((-1.000000000000000000000000e+00*alg[36])+(1.000000000000000000000000e+00*alg[120])+(-1.000000000000000000000000e+00*alg[63])+(-1.000000000000000000000000e+00*alg[69])+(-1.000000000000000000000000e+00*alg[51]));
			der[33 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[48])+(1.000000000000000000000000e+00*alg[66])+(-1.000000000000000000000000e+00*alg[72]));
			der[42 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[51]));
			return;
		case 7:
			alg[33] = __cytoplasm*__k5*x[6];
			alg[36] = __cytoplasm*(__k_plus8*x[6]*x[30]-__k_minus8*x[21]);
			...
			der[6 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[39])+(-1.000000000000000000000000e+00*alg[33])+(-1.000000000000000000000000e+00*alg[36])+(1.000000000000000000000000e+00*alg[57]));
			der[21 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[36])+(-1.000000000000000000000000e+00*alg[54]));
			der[24 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[54])+(-1.000000000000000000000000e+00*alg[57]));
			der[30 + 1] = (1.000000000000000000000000e+00/(__nucleus))*((-1.000000000000000000000000e+00*alg[36])+(1.000000000000000000000000e+00*alg[120])+(-1.000000000000000000000000e+00*alg[63])+(-1.000000000000000000000000e+00*alg[69])+(-1.000000000000000000000000e+00*alg[51]));
			return;
		case 8:
			alg[33] = __cytoplasm*__k5*x[6];
			...
			der[6 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[39])+(-1.000000000000000000000000e+00*alg[33])+(-1.000000000000000000000000e+00*alg[36])+(1.000000000000000000000000e+00*alg[57]));
			der[24 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[54])+(-1.000000000000000000000000e+00*alg[57]));
			der[27 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[57])+(-1.000000000000000000000000e+00*alg[60]));
			return;
		case 9:
			alg[57] = __cytoplasm*__k10*x[24];
			alg[60] = __cytoplasm*__k11*x[27];
		...
		case 10:
			...
			der[30 + 1] = (1.000000000000000000000000e+00/(__nucleus))*((-1.000000000000000000000000e+00*alg[36])+(1.000000000000000000000000e+00*alg[120])+(-1.000000000000000000000000e+00*alg[63])+(-1.000000000000000000000000e+00*alg[69])+(-1.000000000000000000000000e+00*alg[51]));
			der[33 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[48])+(1.000000000000000000000000e+00*alg[66])+(-1.000000000000000000000000e+00*alg[72]));
			der[36 + 1] = (1.000000000000000000000000e+00/(__nucleus))*((-1.000000000000000000000000e+00*alg[69]));
			der[39 + 1] = (1.000000000000000000000000e+00/(__nucleus))*((1.000000000000000000000000e+00*alg[69]));
			der[42 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[51]));
			return;
		case 11:
			alg[30] = __cytoplasm*__k3*x[3]*x[9];
		...
		case 13:
			...
			der[36 + 1] = (1.000000000000000000000000e+00/(__nucleus))*((-1.000000000000000000000000e+00*alg[69]));
			der[39 + 1] = (1.000000000000000000000000e+00/(__nucleus))*((1.000000000000000000000000e+00*alg[69]));
			der[78 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[75])+(-1.000000000000000000000000e+00*alg[111]));
			return;
		case 14:
			alg[36] = __cytoplasm*(__k_plus8*x[6]*x[30]-__k_minus8*x[21]);
			alg[48] = __cytoplasm*(__k_plus7*x[18]*x[33]-__k_minus7*x[15]);
		...
		case 15:
			alg[24] = __cytoplasm*__Vmax1*x[45]*d[(3)]*1.000000000000000000000000e+00/(__Km1+x[45])*__Ki*1.000000000000000000000000e+00/(__Ki+x[66]);
			alg[78] = __cytoplasm*__Vmax2*x[48]*1.000000000000000000000000e+00/(__Km2+x[48]);
			der[45 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[24])+(1.000000000000000000000000e+00*alg[78]));
			der[48 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[24])+(-1.000000000000000000000000e+00*alg[78]));
			return;
		case 16:
			alg[24] = __cytoplasm*__Vmax1*x[45]*d[(3)]*1.000000000000000000000000e+00/(__Km1+x[45])*__Ki*1.000000000000000000000000e+00/(__Ki+x[66]);
			alg[78] = __cytoplasm*__Vmax2*x[48]*1.000000000000000000000000e+00/(__Km2+x[48]);
			...
			der[45 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[24])+(1.000000000000000000000000e+00*alg[78]));
			der[48 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[24])+(-1.000000000000000000000000e+00*alg[78]));
			der[51 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[81])+(1.000000000000000000000000e+00*alg[90])+(1.000000000000000000000000e+00*alg[105])+(-1.000000000000000000000000e+00*alg[84])+(-1.000000000000000000000000e+00*alg[87]));
			der[54 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[81])+(-1.000000000000000000000000e+00*alg[90])+(1.000000000000000000000000e+00*alg[87]));
			return;
		case 17:
			alg[81] = __cytoplasm*__kcat1*x[48]*x[51]*1.000000000000000000000000e+00/(__Km3+x[51]);
			alg[84] = __cytoplasm*(__k18*x[51]*x[72]-__k19*x[69]);
			...
			der[51 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[81])+(1.000000000000000000000000e+00*alg[90])+(1.000000000000000000000000e+00*alg[105])+(-1.000000000000000000000000e+00*alg[84])+(-1.000000000000000000000000e+00*alg[87]));
			der[54 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[81])+(-1.000000000000000000000000e+00*alg[90])+(1.000000000000000000000000e+00*alg[87]));
			der[69 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[105])+(1.000000000000000000000000e+00*alg[84]));
			der[72 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[84])+(1.000000000000000000000000e+00*alg[108]));
			return;
		case 18:
			alg[81] = __cytoplasm*__kcat1*x[48]*x[51]*1.000000000000000000000000e+00/(__Km3+x[51]);
			alg[84] = __cytoplasm*(__k18*x[51]*x[72]-__k19*x[69]);
			...
			der[51 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[81])+(1.000000000000000000000000e+00*alg[90])+(1.000000000000000000000000e+00*alg[105])+(-1.000000000000000000000000e+00*alg[84])+(-1.000000000000000000000000e+00*alg[87]));
			der[54 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[81])+(-1.000000000000000000000000e+00*alg[90])+(1.000000000000000000000000e+00*alg[87]));
			der[57 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[93])+(1.000000000000000000000000e+00*alg[96]));
			der[60 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[93])+(-1.000000000000000000000000e+00*alg[96]));
			return;
		case 19:
			alg[93] = __cytoplasm*__kcat2*x[54]*x[57]*1.000000000000000000000000e+00/(__Km5+x[57]);
			alg[96] = __cytoplasm*__Vmax4*x[60]*1.000000000000000000000000e+00/(__Km6+x[60]);
		...
		case 20:
			...
			der[57 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[93])+(1.000000000000000000000000e+00*alg[96]));
			der[60 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[93])+(-1.000000000000000000000000e+00*alg[96]));
			der[63 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[99])+(1.000000000000000000000000e+00*alg[102]));
			der[66 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[99])+(-1.000000000000000000000000e+00*alg[102]));
			return;
		case 21:
			alg[99] = __cytoplasm*__kcat3*x[60]*x[63]*1.000000000000000000000000e+00/(__Km7+x[63]);
			alg[102] = __cytoplasm*__Vmax5*x[66]*1.000000000000000000000000e+00/(__Km8+x[66]);
		...
		case 22:
			...
			der[66 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[99])+(-1.000000000000000000000000e+00*alg[102]));
			der[69 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((-1.000000000000000000000000e+00*alg[105])+(1.000000000000000000000000e+00*alg[84]));
			der[75 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[105])+(-1.000000000000000000000000e+00*alg[108]));
			der[81 + 1] = (1.000000000000000000000000e+00/(__cytoplasm))*((1.000000000000000000000000e+00*alg[45])+(-1.000000000000000000000000e+00*alg[114]));
			return;
		case 23:
			alg[81] = __cytoplasm*__kcat1*x[48]*x[51]*1.000000000000000000000000e+00/(__Km3+x[51]);
		...
		case 28:
			...
			alg[15] = d[(6)];
			alg[18] = alg[15];
			der[84 + 1] = (__ap*__math__pow(x[84],__n)+__bp)*1.000000000000000000000000e+00/(__mp+alg[3]+__cpp*__math__pow(x[84],__n))-__kp*x[84];
			der[87 + 1] = (__ao*__math__pow(x[87],__n)+__bo+alg[12])*1.000000000000000000000000e+00/(__mo+__coo*__math__pow(x[87],__n)+__coa*__math__pow(x[90],__n)+__cop*__math__pow(x[84],__n))-__ko*x[87];
			der[90 + 1] = (__aa*__math__pow(x[90],__n)+__ba+alg[18])*1.000000000000000000000000e+00/(__ma+__caa*__math__pow(x[90],__n)+__cao*__math__pow(x[87],__n)+__cap*__math__pow(x[84],__n))-__ka*x[90];
			return;
		case 29:
			alg[6] = d[(0)];
			alg[9] = alg[6];
...
MOD_zeroCrossing(int i, double *x, double *d, double *alg, double t, double *zc)
{
	switch(i)
	{
		...
		case 1:
			...
			return;
		case 2:
			zc[0] = x[39]-(1.100000000000000088817842e+00*__normal_bCatenin_TCF);
			return;
		case 3:
			zc[0] = d[(3)]-(0.0);
			return;
...
MOD_handlerPos(int i, double *x, double *d, double *alg, double t)
{
	...
	if(d[(2)]==0.0)
	{
			d[(5)] = t+__math__exponential(1.000000000000000020816682e-02);
	}
	else
	{
			d[(5)] = d[(1)];
	...
	if(d[(6)]==0.0)
	{
			d[(4)] = t+__math__exponential(1.000000000000000020816682e-03);
	}
	else
	{
			d[(4)] = d[(1)];
...
QSS_data modelData = simulator->data;
	...
	__cytoplasm = 1.000000000000000000000000e+00;
	__nucleus = 1.000000000000000000000000e+00;
	__k1 = 1.819999999999999951150187e-01;
	__k2 = 1.820000000000000089928065e-02;
	__k3 = 5.000000000000000277555756e-02;
	__k4 = 2.670000000000000150990331e-01;
	__k5 = 1.330000000000000071054274e-01;
	__k_plus6 = 9.089999999999999469313394e-02;
	__k_minus6 = 9.090000000000000301980663e-01;
	__k_plus7 = 1.000000000000000000000000e+00;
	__k_minus7 = 5.000000000000000000000000e+01;
	__k_plus8 = 1.000000000000000000000000e+00;
	__k_minus8 = 1.200000000000000000000000e+02;
	__k9 = 2.060000000000000000000000e+02;
	__k10 = 2.060000000000000000000000e+02;
	__k11 = 4.169999999999999817923424e-01;
	__V12 = 4.229999999999999871214129e-01;
	__k13 = 2.570000000000000127224620e-04;
	__k14 = 8.220000000000000580941545e-05;
	__k21 = 9.999999999999999547481118e-07;
	__k15 = 1.670000000000000095479180e-01;
	__k_plus16 = 1.000000000000000000000000e+00;
	__k_minus16 = 3.000000000000000000000000e+01;
	__k_plus17 = 1.000000000000000000000000e+00;
	__k_minus17 = 1.200000000000000000000000e+03;
	__Vmax1 = 1.500000000000000000000000e+02;
	__Km1 = 1.000000000000000000000000e+01;
	__Ki = 9.000000000000000000000000e+00;
	__Vmax2 = 1.500000000000000000000000e+01;
	__Km2 = 8.000000000000000000000000e+00;
	__kcat1 = 1.500000000000000000000000e+00;
	__Km3 = 1.500000000000000000000000e+01;
	__Vmax3 = 4.500000000000000000000000e+01;
	__Km4 = 1.500000000000000000000000e+01;
	__kcat2 = 1.500000000000000000000000e+00;
	__Km5 = 1.500000000000000000000000e+01;
	__Vmax4 = 4.500000000000000000000000e+01;
	__Km6 = 1.500000000000000000000000e+01;
	__kcat3 = 1.500000000000000000000000e+00;
	__Km7 = 1.500000000000000000000000e+01;
	__Vmax5 = 4.500000000000000000000000e+01;
	__Km8 = 1.500000000000000000000000e+01;
	__kcat4 = 1.500000000000000000000000e+00;
	__Km9 = 9.000000000000000000000000e+00;
	__k18 = 1.499999999999999944488849e-01;
	__k19 = 3.900000000000000000000000e+01;
	__Vmax6 = 4.500000000000000000000000e+01;
	__Km10 = 1.200000000000000000000000e+01;
	__kcat5 = 5.999999999999999777955395e-01;
	__n1 = 2.000000000000000000000000e+00;
	__Km11 = 1.500000000000000000000000e+01;
	__k20 = 1.499999999999999944488849e-02;
	__kcat6 = 1.500000000000000000000000e+00;
	__Km12 = 1.500000000000000000000000e+01;
	__kcat7 = 1.500000000000000000000000e+00;
	__Km13 = 1.500000000000000000000000e+01;
	__Vmax7 = 4.500000000000000000000000e+01;
	__Km14 = 1.500000000000000000000000e+01;
	__normal_bCatenin_TCF = 8.810000000000000497379915e+00;
	__n = 2.0;
	__ap = 2.000000000000000111022302e-01;
	__bp = 5.000000000000000000000000e-01;
	__mp = 10.0;
	__cpp = 1.000000000000000055511151e-01;
	__kp = 1.000000000000000055511151e-01;
	__ao = 1.000000000000000055511151e-01;
	__aa = 1.000000000000000055511151e-01;
	__bo = 1.0;
	__ba = 1.0;
	__mo = 1.0;
	__ma = 1.0;
	__coo = 1.000000000000000055511151e-01;
	__caa = 1.000000000000000055511151e-01;
	__coa = 1.000000000000000055511151e-01;
	__cao = 1.000000000000000055511151e-01;
	__cop = 5.000000000000000000000000e-01;
	__cap = 5.000000000000000000000000e-01;
	__ko = 1.000000000000000055511151e-01;
	__ka = 1.000000000000000055511151e-01;
	modelData->x[90] = 0.0;
	modelData->x[87] = 0.0;
	modelData->x[84] = 12.0;
	...
	// Initialize model code.
		modelData->d[(5)] = __math__exponential(1.000000000000000020816682e-02);
		modelData->d[(4)] = __math__exponential(1.000000000000000020816682e-03);
	modelData->nDS[28] = 1;
	modelData->nDS[29] = 3;
	modelData->nDS[30] = 3;
	modelData->nDS[0]++;
