...
MOD_definition(double *x, double *d, double *alg, double t, double *dx)
{
	...
	for(i = 1; i <= 8; i++)
	{
		...
		alg[(i+100) * 1] = d[(i)]*__PAR_bnoslip*alg[(i+90) * 1]*__PAR_m*__PAR_g+(1.0-d[(i)])*(__PAR_fric_coef_dyn*alg[(i+90) * 1]*__PAR_m*__PAR_g+__PAR_bslip*alg[(i+90) * 1]*__PAR_m*__PAR_g);
	...
	for(i = 1; i <= 8; i++)
	{
		...
		alg[(i+90) * 1] = __PAR_R*x[(i) * 1]-x[(i+20) * 1];
		alg[(i+100) * 1] = d[(i)]*__PAR_bnoslip*alg[(i+90) * 1]*__PAR_m*__PAR_g+(1.0-d[(i)])*(__PAR_fric_coef_dyn*alg[(i+90) * 1]*__PAR_m*__PAR_g+__PAR_bslip*alg[(i+90) * 1]*__PAR_m*__PAR_g);
		alg[(i+110) * 1] = alg[(i+60) * 1]*alg[(i+30) * 1]+alg[(i+70) * 1]*alg[(i+40) * 1]+alg[(i+80) * 1]*alg[(i+50) * 1]+alg[(i+100) * 1]+__PAR_kc*(x[(i+11) * 1]+x[(i+9) * 1]-2.0*x[(i+10) * 1])+__PAR_bc*(x[(i+21) * 1]+x[(i+19) * 1]-2.0*x[(i+20) * 1]);
