...
MOD_definition(int i, double *x, double *d, double *alg, double t, double *dx)
{
	...
	{
		case 0:
			dx[1] = __vi-__vd*x[6]*(x[0]*1.000000000000000000000000e+00/(__Kd+x[0]))-__kd*x[0];
			return;
		case 1:
			dx[1] = (x[0]*1.000000000000000000000000e+00/(__kc+x[0]))*__vm1*(1.0-x[3])*1.000000000000000000000000e+00/(__k1+(1.0-x[3]))-__v2*x[3]*1.000000000000000000000000e+00/(__k2+x[3]);
			return;
		case 2:
			dx[1] = x[3]*__vm3*(1.0-x[6])*1.000000000000000000000000e+00/(__k3+(1.0-x[6]))-__v4*x[6]*1.000000000000000000000000e+00/(__k4+x[6]);
			return;
	}
}
...
MOD_dependencies(int i, double *x, double *d, double *alg, double t, double *der, int *map)
{
	...
	{
		case 0:
			der[0 + 1] = __vi-__vd*x[6]*(x[0]*1.000000000000000000000000e+00/(__Kd+x[0]))-__kd*x[0];
			der[3 + 1] = (x[0]*1.000000000000000000000000e+00/(__kc+x[0]))*__vm1*(1.0-x[3])*1.000000000000000000000000e+00/(__k1+(1.0-x[3]))-__v2*x[3]*1.000000000000000000000000e+00/(__k2+x[3]);
			return;
		case 1:
			der[3 + 1] = (x[0]*1.000000000000000000000000e+00/(__kc+x[0]))*__vm1*(1.0-x[3])*1.000000000000000000000000e+00/(__k1+(1.0-x[3]))-__v2*x[3]*1.000000000000000000000000e+00/(__k2+x[3]);
			der[6 + 1] = x[3]*__vm3*(1.0-x[6])*1.000000000000000000000000e+00/(__k3+(1.0-x[6]))-__v4*x[6]*1.000000000000000000000000e+00/(__k4+x[6]);
			return;
		case 2:
			der[0 + 1] = __vi-__vd*x[6]*(x[0]*1.000000000000000000000000e+00/(__Kd+x[0]))-__kd*x[0];
			der[6 + 1] = x[3]*__vm3*(1.0-x[6])*1.000000000000000000000000e+00/(__k3+(1.0-x[6]))-__v4*x[6]*1.000000000000000000000000e+00/(__k4+x[6]);
