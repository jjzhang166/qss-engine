...
AST_Declaration
newAST_Declaration (AST_String s, AST_ExpressionList indexes,
		    AST_Modification m)
{
...
AST_Expression_ComponentReferenceExpAddDot (
    AST_Expression_ComponentReference cr, AST_String id, AST_String rest,
