...
private:
  ...
  _eventVectorDependencies (Index index, Dependencies deps, WR_Section alloc,
			   ...
			   string initString, DEP_Type type);
  void
  _init ();
  void
...
public:
  ...
  vectorDependencies (Index index, Dependencies deps, WR_Section alloc,
		     ...
		     WR_Section allocInverse, WR_Section initInverse,
		     string allocInverseString, string initInverseString,
		     string count = "states", string countInverse = "states",
   ...
   */
  void
  addAlgebriacDeps (Dependencies deps, Index derivativeIndex, map<Index,Index> states, string alloc,
		     string allocInverse, string init, string initInverse,
		     WR_Section allocSection, WR_Section allocInverseSection, WR_Section initSection, WR_Section initInverseSection,
		     string type, string inverseType, DEP_Type depType = DEP_ALGEBRAIC_STATE, MMO_DependenciesTable modelDeps = NULL);
  /**
   *
   * @param deps
   * @param state
