...
typedef enum
{
  SOL_MODEL_SETTINGS, SOL_MODEL, SOL_DEPS, SOL_ZC, SOL_HANDLER_POS, SOL_HANDLER_NEG, SOL_OUTPUT, SOL_INIT, SOL_CALLBACK
} SOL_Function;
...
typedef enum
{
    SOL_SERIAL, SOL_PARALLEL
} SOL_Engine;

typedef enum
{
    NOD_SD, NOD_SZ, NOD_HD, NOD_HZ, NOD_DD
} NOD_Type;
