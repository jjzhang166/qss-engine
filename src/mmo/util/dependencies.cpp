...
Dependencies_::Dependencies_ () :
        _autonomous (true), _stateVectorsCount (0), _discreteVectorsCount (0), _algebraicVectorsCount (0)
{
...
Dependencies_::stateVectors ()
{
    ...
    for (Index *idx = _stateVectors->begin (); !_stateVectors->end (); idx = _stateVectors->next ())
    {
...
Dependencies_::discreteVectors ()
{
    ...
    for (Index *idx = _discreteVectors->begin (); !_discreteVectors->end (); idx = _discreteVectors->next ())
    {
