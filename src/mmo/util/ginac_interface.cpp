...
/* Dummy functions used as wrappers for user defined functions. */

// DUMMY1

REGISTER_FUNCTION(dummy14, dummy())

static ex
dummy13_derivative (const ex & x, const ex &y, unsigned diff_param)
{
  return (dummy14 (x));
}

REGISTER_FUNCTION(dummy13, derivative_func(dummy13_derivative))

static ex
dummy12_derivative (const ex & x, const ex &y, unsigned diff_param)
{
  return (dummy13 (x,y));
}

REGISTER_FUNCTION(dummy12, derivative_func(dummy12_derivative))

static ex
dummy1_derivative (const ex & x, const ex &y, unsigned diff_param)
{
  return (dummy12 (x, y));
}

REGISTER_FUNCTION(dummy1, derivative_func(dummy1_derivative))

// DUMMY2

REGISTER_FUNCTION(dummy24, dummy())

static ex
dummy23_derivative (const ex & x, const ex &y, unsigned diff_param)
{
  return (dummy24 (x));
}

REGISTER_FUNCTION(dummy23, derivative_func(dummy23_derivative))

static ex
dummy22_derivative (const ex & x, const ex &y, unsigned diff_param)
{
  return (dummy23 (x,y));
}

REGISTER_FUNCTION(dummy22, derivative_func(dummy22_derivative))

static ex
dummy2_derivative (const ex & x, const ex &y, unsigned diff_param)
{
  return (dummy22 (x, y));
}

REGISTER_FUNCTION(dummy2, derivative_func(dummy2_derivative))

// DUMMY3

REGISTER_FUNCTION(dummy34, dummy())

static ex
dummy33_derivative (const ex & x, const ex &y, unsigned diff_param)
{
  return (dummy34 (x));
}

REGISTER_FUNCTION(dummy33, derivative_func(dummy33_derivative))

static ex
dummy32_derivative (const ex & x, const ex &y, unsigned diff_param)
{
  return (dummy33 (x,y));
}

REGISTER_FUNCTION(dummy32, derivative_func(dummy32_derivative))

static ex
dummy3_derivative (const ex & x, const ex &y, unsigned diff_param)
{
  return (dummy32 (x, y));
}

REGISTER_FUNCTION(dummy3, derivative_func(dummy3_derivative))

// DUMMY4

REGISTER_FUNCTION(dummy44, dummy())

static ex
dummy43_derivative (const ex & x, const ex &y, unsigned diff_param)
{
  return (dummy44 (x));
}

REGISTER_FUNCTION(dummy43, derivative_func(dummy43_derivative))

static ex
dummy42_derivative (const ex & x, const ex &y, unsigned diff_param)
{
  return (dummy43 (x,y));
}

REGISTER_FUNCTION(dummy42, derivative_func(dummy42_derivative))

static ex
dummy4_derivative (const ex & x, const ex &y, unsigned diff_param)
{
  return (dummy42 (x, y));
}

REGISTER_FUNCTION(dummy4, derivative_func(dummy4_derivative))

// DUMMY5

REGISTER_FUNCTION(dummy54, dummy())

static ex
dummy53_derivative (const ex & x, const ex &y, unsigned diff_param)
{
  return (dummy54 (x));
}

REGISTER_FUNCTION(dummy53, derivative_func(dummy53_derivative))

static ex
dummy52_derivative (const ex & x, const ex &y, unsigned diff_param)
{
  return (dummy53 (x,y));
}

REGISTER_FUNCTION(dummy52, derivative_func(dummy52_derivative))

static ex
dummy5_derivative (const ex & x, const ex &y, unsigned diff_param)
{
  return (dummy52 (x, y));
}

REGISTER_FUNCTION(dummy5, derivative_func(dummy5_derivative))

// DUMMY6

REGISTER_FUNCTION(dummy64, dummy())

static ex
dummy63_derivative (const ex & x, const ex &y, unsigned diff_param)
{
  return (dummy64 (x));
}

REGISTER_FUNCTION(dummy63, derivative_func(dummy63_derivative))

static ex
dummy62_derivative (const ex & x, const ex &y, unsigned diff_param)
{
  return (dummy63 (x,y));
}

REGISTER_FUNCTION(dummy62, derivative_func(dummy62_derivative))

static ex
dummy6_derivative (const ex & x, const ex &y, unsigned diff_param)
{
  return (dummy62 (x, y));
}

REGISTER_FUNCTION(dummy6, derivative_func(dummy6_derivative))

// DUMMY7

REGISTER_FUNCTION(dummy74, dummy())

static ex
dummy73_derivative (const ex & x, const ex &y, unsigned diff_param)
{
  return (dummy74 (x));
}

REGISTER_FUNCTION(dummy73, derivative_func(dummy73_derivative))

static ex
dummy72_derivative (const ex & x, const ex &y, unsigned diff_param)
{
  return (dummy73 (x,y));
}

REGISTER_FUNCTION(dummy72, derivative_func(dummy72_derivative))

static ex
dummy7_derivative (const ex & x, const ex &y, unsigned diff_param)
{
  return (dummy72 (x, y));
}

REGISTER_FUNCTION(dummy7, derivative_func(dummy7_derivative))

// DUMMY8

REGISTER_FUNCTION(dummy84, dummy())

static ex
dummy83_derivative (const ex & x, const ex &y, unsigned diff_param)
{
  return (dummy84 (x));
}

REGISTER_FUNCTION(dummy83, derivative_func(dummy83_derivative))

static ex
dummy82_derivative (const ex & x, const ex &y, unsigned diff_param)
{
  return (dummy83 (x,y));
}

REGISTER_FUNCTION(dummy82, derivative_func(dummy82_derivative))

static ex
dummy8_derivative (const ex & x, const ex &y, unsigned diff_param)
{
  return (dummy82 (x, y));
}

REGISTER_FUNCTION(dummy8, derivative_func(dummy8_derivative))
...
ex
ConvertToGiNaC::convert (AST_Expression e, bool replaceDer,
...
ConvertToGiNaC::foldTraverseElement (AST_Expression e)
{
  switch (e->expressionType ())
	...
	if (!_forDerivation)
	  ...
	  {
	    VarInfo v = _varEnv->lookup (
		e->getAsComponentReference ()->name ());
	...
	if (toStr(c->name()) == "sin")
	  {
	    return (sin (convert (AST_ListFirst (c->arguments ()), _replaceDer,
			 _generateIndexes)));
	  }
	else if (toStr(c->name()) == "cos")
	  {
	    return (cos (convert (AST_ListFirst (c->arguments ()), _replaceDer,
			 _generateIndexes)));
	  }
	else if (toStr(c->name()) == "log")
	  {
	    return (log (convert (AST_ListFirst (c->arguments ()), _replaceDer,
			 _generateIndexes)));
	  }
	else if (toStr(c->name()) == "pre")
	  {
	    return (pre (convert (AST_ListFirst (c->arguments ()), _replaceDer,
			 _generateIndexes)));
	  }
	  ...
	  {
	    return (der3 (convert (AST_ListFirst (c->arguments ()), _replaceDer,
			 _generateIndexes)));
	  }
	  ...
	  {
	    return (exp (convert (AST_ListFirst (c->arguments ()), _replaceDer,
			 _generateIndexes)));
	  }
	else
	  {
    ...
    case EXPOUTPUT:
      {
	AST_Expression el = AST_ListFirst (
	    e->getAsOutput ()->expressionList ());
